...
export default function CareRemindersPage() {
  ...
  const handleEditReminderSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data: { user } } = await supabase.auth.getUser()
      if (!user || !editingReminder) throw new Error('No user or reminder found')
  ...
  const getRemindersForDate = (date: Date) => {
    ...
    return reminders.filter(reminder => {
      if (selectedPatientId && reminder.patient_id !== selectedPatientId) return false
  ...
  const getCallLogsForDate = (date: Date) => {
    ...
    return callLogs.filter(log => {
      if (selectedPatientId && log.patient_id !== selectedPatientId) return false
  ...
  const handleReminderClick = async (reminder: CareReminder, clickDate: Date) => {
    if (isDateInFuture(clickDate)) {
      ...
      const callLog = callLogs.find(log =>
        ...
        log.scheduled_time?.split('T')[0] === clickDate.toISOString().split('T')[0]
      )
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">This page is only accessible to caregivers.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="flex">
      ...
      <div className="flex-1 ml-64 p-8 bg-gray-50 min-h-screen">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Care Reminders</h1>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-200">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div className="flex-1">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Filter & Actions</h2>
              ...
              <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex justify-between items-center">
                    <h3 className="text-xl font-bold text-gray-900">Add Care Reminder</h3>
                    <button
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setReminderForm(prev => ({ ...prev, patient_id: e.target.value }))}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setReminderForm(prev => ({ ...prev, category: e.target.value as CareReminder['category'] }))}
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                      >
                    ...
                    <div className="grid grid-cols-7 gap-2">
                      {[
                        ...
                        <label key={day.key} className="flex flex-col items-center">
                          <span className="text-xs text-gray-600 mb-1">{day.label}</span>
                          <input
                            type="checkbox"
                            checked={reminderForm[day.key as keyof typeof reminderForm] as boolean}
                            onChange={(e) => setReminderForm(prev => ({ ...prev, [day.key]: e.target.checked }))}
          ...
          {showCallForm && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex justify-between items-center">
                    <h3 className="text-xl font-bold text-gray-900">Log Care Call</h3>
                    <button
                ...
                <form onSubmit={handleCallSubmit} className="p-6 space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setCallForm(prev => ({ ...prev, patient_id: e.target.value }))}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setCallForm(prev => ({ ...prev, status: e.target.value as CallLog['status'] }))}
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setCallForm(prev => ({ ...prev, scheduled_time: e.target.value }))}
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setCallForm(prev => ({ ...prev, call_duration: parseInt(e.target.value) || 0 }))}
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="0"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setCallForm(prev => ({ ...prev, call_summary: e.target.value }))}
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      rows={4}
          ...
          {showEditReminderForm && editingReminder && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex justify-between items-center">
                    <h3 className="text-xl font-bold text-gray-900">Edit Care Reminder</h3>
                    <button
                      onClick={() => {
                        setShowEditReminderForm(false)
                        setEditingReminder(null)
                ...
                <form onSubmit={handleEditReminderSubmit} className="p-6 space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Patient</label>
                      <select
                    ...
                    <div className="grid grid-cols-4 md:grid-cols-7 gap-3">
                      {[
                        ...
                        <label key={key} className="flex items-center">
                          <input
                            type="checkbox"
                            checked={reminderForm[key as keyof typeof reminderForm] as boolean}
                            onChange={(e) => setReminderForm(prev => ({ ...prev, [key]: e.target.checked }))}
                            className="sr-only"
                          />
                          <div className={`cursor-pointer px-3 py-2 rounded-lg text-center transition-colors ${
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-900">{selectedCallLog.patient_name}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Scheduled Time:</span>
                        <span className="text-gray-900">
                          {new Date(selectedCallLog.scheduled_time).toLocaleString()}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Duration:</span>
                        <span className="text-gray-900">
                          {selectedCallLog.call_duration ? `${selectedCallLog.call_duration} minutes` : 'Not recorded'}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Status:</span>
                        <span className={`px-2 py-1 rounded text-xs font-medium ${
                          selectedCallLog.status === 'completed' ? 'bg-green-100 text-green-800' :
                          selectedCallLog.status === 'missed' ? 'bg-red-100 text-red-800' :
                  ...
                  {selectedCallLog.call_summary && (
                    <div>
                      ...
                      <div className="bg-blue-50 rounded-lg p-4">
                        <p className="text-gray-800">{selectedCallLog.call_summary}</p>
                      </div>
                    </div>
                  )}
