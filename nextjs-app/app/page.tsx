      ...
      <div className="relative z-10">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-center">
                  ...
                  <div className="hidden md:flex items-center space-x-4">
                    ...
                    <a href={`/login?type=${userType}`} className={`px-4 sm:px-6 py-2 rounded-lg sm:rounded-xl transition-all transform hover:scale-105 font-medium shadow-lg text-sm sm:text-base ${
                      userType === 'patient' 
        ...
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 text-center relative">
          ...
          <div className={`relative z-10 transition-all duration-1000 transform ${
            ...
            <h1 className={`text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 leading-tight transition-all duration-700 transform ${
              ...
              <span className={`block sm:inline ${userType === 'caregiver' ? 'text-green-800' : 'text-blue-800'}`}>
                {userTypeContent[userType].subtitle}
              </span>
            </h1>
            
            <p className={`text-base sm:text-lg md:text-xl lg:text-2xl max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto mb-8 sm:mb-12 leading-relaxed transition-all duration-700 transform px-4 sm:px-0 ${
            ...
            <div className={`flex justify-center transition-all duration-700 transform px-4 sm:px-0 ${
