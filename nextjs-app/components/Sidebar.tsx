    ...
    return (
      <li>
        ...
        >
          ...
          {!isCollapsed && (
            <span className="ml-3 font-medium text-left">{label}</span>
          )}
        </button>
      </li>
    );
      ...
      {!isCollapsed && (
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center text-white text-lg bg-gradient-to-br ${
                isPatient
